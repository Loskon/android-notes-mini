...
public class NoteSnackbar {
    ...
    public void registerCallBackNote(CallbackRestoreNote callbackRestoreNote) {
        NoteSnackbar.callbackRestoreNote = callbackRestoreNote;
    }

    public NoteSnackbar(Activity activity, View layout, View anchorView) {
    ...
    public void showSnackbarErrors(boolean isPermissionGranted) {
        ...
        MySnackbar.makeSnackbar(activity, layout, message, anchorView, false);
    }
