...
/**
 * Кастомный элемент настроек с слайдером
 */
...
class PrefScreenNumberLines @JvmOverloads constructor(
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        ...
        context.apply {
            ...
            val color: Int = AppPref.getAppColor(this)
            ...
            slider.addOnChangeListener(Slider.OnChangeListener { _, value: Float, _ ->
                ...
                AppPref.save(this, prefKey, number)
                callback?.onChangeNumberLines(number)
            })
        }
    }

    interface CallbackNumberLinesUpdate {
        fun onChangeNumberLines(numberLines: Int)
    }

    companion object {
        private var callback: CallbackNumberLinesUpdate? = null

        fun listenerCallback(callback: CallbackNumberLinesUpdate) {
