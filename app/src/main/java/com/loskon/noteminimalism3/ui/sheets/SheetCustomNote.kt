...
class SheetCustomNote(private val context: Context) : View.OnClickListener {

    private val activity: NoteActivity = context as NoteActivity
    private val textAssistant: TextAssistant = TextAssistant(activity)
